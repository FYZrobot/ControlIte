%%%%%%% 观察当前关节与前、后关节的角度、角速度对非线性的影响 %%%%%%

tic
clear all;clc;
load CSof7DF;
CFK=zeros(6,1);CFC=zeros(6,1);CF=zeros(6,1);
for i=1:6
qm=[40,20,60,60,i*15,-85,40]'*pi/180;
% qm=[40,20+j*30,i*60,-60,15,-85,40]'*pi/180;
vqm=[2 2 2 2 2 2 2]'*pi/180;
